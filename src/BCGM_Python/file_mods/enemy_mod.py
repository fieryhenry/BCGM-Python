...
values = [
    ...
    "Weaken Duration",
    "Weaken %",
    "Strengthen Activation health",
    "Strengthen Multiplier",
    "Survive Lethal Chance",
    "Long distance start",
    "Long distance range",
    "Wave Immunity",
    "?",
    ...
    "Revive count",
    "Revive time",
    "Percentage of health after revive",
    "Witch Flag",
    "Is enemy base flag",
    "loop?",
    "?",
    "Self-Destruct Flag (2=self-destruct)",
    "?",
    "Soul when dead",
    "Second attack damage",
    "Third attack damage",
    "Second attack start frame",
    "Third attack start frame",
    "Use ability on first hit flag",
    "Second attack flag",
    "Third attack flag",
    "?",
    "Some flag for gudetama",
    "Barrier HP",
    "Warp Chance",
    "Warp Duration",
    "Warp min range",
    "Warp max range",
    "Starred Alien Flag (2-4 = god)",
    "Some flag for doge sun and the winds",
    "Eva angel flag",
    "Relic flag",
    "Curse Chance",
    "Cuse Duration",
    "Savage Blow Chance",
    "Savage Blow Multiplier",
    "Invincibility Chance",
    "Invincibility Duration",
    "Toxic Chance",
    "Toxic Percentage health",
    "Surge Chance",
    "Surge Min range",
    "Surge max range",
    "Surge Level",
    "Some flag for doge sun, wind enemies and doron",
    "Mini wave toggle",
    "Shield HP",
    "Percentage HP healed when knockbacked",
    "Surge Chance when killed",
    "Surge min range when killed",
    "Surge max range when killed",
    "Surge Level when killed",
    "Aku flag",
    "Baron Trait Flag",
]
...
def edit_enemy():
    csv_path = helper.select_files(
        "Select t_unit.csv file",
        [("Enemy stats", "t_unit.csv")],
        default=unit_mod.get_initial_dir(),
    )
    if not csv_path:
